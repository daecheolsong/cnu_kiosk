...
"""
    ...
    --> console 
    백엔드 개발자 
    2.controller 단 (조작) - java
    --> python
    3.model 단 (Database) - 저장
    --> Dict,list
...
if menu_num == 1:    # 햄버거 세트
    ...
    # choice.choice() => choice_menu.py에서 choice_burger 함수를 호출
...
print(menu_save)
print(price_save)
for price in price_save.values(): ## key value
    total_price += price

print('■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■')
print('■■ 고객님이 주문하신 메뉴는 ')
for i,menu in enumerate(menu_save.values()): # index value
